<?php
// Définir l'encodage interne de PHP
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    // Vérifier l'encodage et forcer UTF-8
    ...
    // Force l'encodage UTF-8 lors de l'écriture du JSON
    if (file_put_contents($jsonFile, json_encode($recipeData, JSON_PRETTY_PRINT | JSON_UNESCAPED_UNICODE | JSON_INVALID_UTF8_IGNORE)) === false) {
